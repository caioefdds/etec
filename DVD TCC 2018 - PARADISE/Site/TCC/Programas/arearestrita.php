				...
				<ul class="nav navbar-nav navbar-right">
					...
					">
					 <form method="post" action="arearestrita.php">
					  <h2><font face="century gothic" color="white" >AREA RESTRITA</h2>
					  <form class="form-horizontal">
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">USUÁRIO:</label>
								<div class="col-sm-10">
									<input type="text" class="form-control" name="frm_login" id="frm_login" placeholder="Insira seu e-mail" maxlength="50" required><br>
								</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="senha">SENHA:</label>
								<div class="col-sm-10">          
									<input type="password" class="form-control" name="frm_senha" id="frm_senha" placeholder="Insira sua senha" maxlength="50" required><br>
								</div>
						</div>
						</font>
						<div class="form-group">        
							...
							<?php
								if(isset($_POST["submit"]))
								{
									...
									$query="select * from usuarios where usu_login='$login' and usu_senha='$senha' and usu_nivel='$nivel'";
					...
					<?php
									...
									{
										print("<script>alert(\"falha no login. VocÃª nÃ£o Ã© um ADMINISTRADOR.\")</script>");
										print("<meta http-equiv=\"refresh\" content=\"0\">");
									}
								}
							?>
